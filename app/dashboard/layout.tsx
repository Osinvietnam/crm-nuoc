...
export default function DashboardLayout({ children }: { children: React.ReactNode }) {
  ...
  // Thứ tự chuẩn: Tổng quan → Công việc → Lịch → Khách hàng → Báo giá → Hợp đồng
  //               → Sản phẩm → Bảo hành → Bảo trì → Tài chính → Nhân viên → Quản trị
  const menuByRole: Record<string, { href: string; label: string; icon: string }[]> = {
    admin: [
      ...
      { href: '/dashboard/quy-trinh',   label: 'Quy trình',  icon: '🔀' },
